...
`;
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      title: "Endereço",
      content: "Av. Maranhão, 1465 - Ivaiporã, PR",
      link: "#",
    },
    {
      icon: (
      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16">
          ...
          <p className="text-lg" style={{ color: "var(--text-secondary)" }}>
            Estamos prontos para ajudar você a alcançar seus objetivos. Entre em
            contato e descubra como podemos transformar sua visão em realidade.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8 md:gap-12">
          ...
          <div className="space-y-6">
            {contactInfo.map((info, index) => (
              <a
                key={index}
                href={info.link}
                className="flex items-start gap-0 p-4 md:p-6 rounded-xl transition-all duration-300 hover:transform hover:scale-105"
                style={{
          ...
          {/* Contact Form */}
          <div
            className="lg:col-span-2 p-5 md:p-8 rounded-2xl"
            style={{
              backgroundColor: "var(--card-bg)",
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-2.5 md:py-3 rounded-lg transition-all duration-300 focus:outline-none"
                    style={{
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={6}
                  className="w-full px-4 py-2.5 md:py-3 rounded-lg transition-all duration-300 focus:outline-none resize-none"
                  style={{
                    border: "2px solid var(--card-border)",
                    color: "var(--text-primary)",
                  }}
              ...
              <button
                ...
                className="w-full px-6 py-3 md:py-4 rounded-lg font-semibold transition-all duration-300 hover:transform hover:scale-105 hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                style={{
